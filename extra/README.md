...
Follow these 9 guides in numerical order (**Step 01 ➔ Step 09**) to understand the full project architecture, code execution lifecycle, and Clean Architecture design patterns.
...
Step 01: Full Monorepo Architecture (Backend + Mobile + Firebase)
   │
   ▼
...
Step 03: Source Code Map (mobile/lib/ Clean Architecture layers)
       ...
       LEVEL 2: BOOTSTRAPPING & BACKEND CONNECTION
...
Step 06: Core Infrastructure (mobile/lib/core: DI, Keystore Storage, Network, Errors)
   │
   ▼
...
|:---:|:---|:---|
| **Step 01** | [`Step_01_Project_Architecture.md`](Step_01_Project_Architecture.md) | **Start Here.** The full bird's-eye view: how the Flutter client, Express backend, and Firebase serverless engine interact. |
...
| **Step 06** | [`Step_06_Core_Infrastructure.md`](Step_06_Core_Infrastructure.md) | The engine room: Dependency Injection via `GetIt`, encrypted hardware storage, network client, and JnU validators. |
